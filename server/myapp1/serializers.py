...
class ReportSerializer(CustomSerializer):
    month_year = serializers.DateField(format="%Y-%m", input_formats=["%m/%Y", "%Y-%m"])
...
class MemberSerializer(CustomSerializer):
    class Meta:
        model = Member
        fields = "__all__"


class CollectionSerializer(CustomSerializer):
    class Meta:
        model = Collection
        fields = "__all__"
    ...
    def validate(self, data):
        ...
        if end_month < start_month:
            raise serializers.ValidationError("End month must be ahead of start month.")

        return data


class ExpenseSerializer(CustomSerializer):
    class Meta:
        model = Expense
        fields = "__all__"


class IncomeSerializer(CustomSerializer):
    class Meta:
        model = Income
        fields = "__all__"


class TransferSerializer(CustomSerializer):
    class Meta:
        model = Transfer
        fields = "__all__"
